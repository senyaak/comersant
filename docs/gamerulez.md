...
**Игра по экономике для начинающих**

## Описание игры

Наше время — время перехода к рыночным отношениям. Среди людей, особенно молодого поколения, проявляется все больший интерес к экономике и, в первую очередь, к ее новым проявлениям.

Настоящая игра — это попытка показать в общих чертах определенные моменты рынка, его законы, «подводные камни». Игра научит вас:
- Нестандартно мыслить
- Быстро принимать смелые решения с дальним расчетом
- Тренирует самостоятельность
- Развивает творческое мышление и сообразительность
- Укрепляет память
...
- **Игровое поле** — разбито на сектора (участки), представляющие предприятия торговой и спортивно-культурной сферы
- **3 кубика**
- **До 6 фишек** — по одной на каждого игрока
- **Три пачки карточек**: «Риск», «Письмо» и «Сюрприз»
- **Знаки собственности**: «Предприятие» (П), «Отделение» (О) и «Филиал» (Ф)
- **Карточки «Собственность»** — идентичные участкам на игровом поле
- **Банкноты** различной стоимости
- **Красные кружки** — обозначают право выкупа государственного предприятия
...
1. Разложите **красные кружки** против любого из участков (клеток) поля, за исключением клеток «Госпредприятие»
2. Положите карточки **«Собственность»**, **«Риск»**, **«Сюрприз»** и **«Письмо»** отдельными стопками
3. Карточки «Риск», «Сюрприз» и «Письмо» кладутся **картинкой вверх**
4. Разрежьте карточки и денежные знаки перед игрой

### Стартовый капитал

Каждый игрок получает:
- **Фишку** определенного цвета
- **250,000 рублей** в банкнотах

**Исключение для банкира**: получает **280,000 рублей** (в связи с тем, что постоянно отвлекается на проведение финансовых операций).

### Выбор банкира

Один из игроков становится **банкиром**. Это должен быть наиболее ответственный и умеющий быстро считать игрок.

**Задачи банкира**:
- Принимать и выдавать платежи
- Проводить аукционы
...
1. Все игроки бросают **три кубика**
2. У кого получится **наибольшая сумма** — получает право первого хода
3. Далее продолжает игрок, сидящий **слева**, и далее **по часовой стрелке**
...
3. Банкир выдает игроку **карту «Собственность»**, идентичную приобретенному участку

**При отказе от покупки**: банкир имеет право реализовать участок другим игрокам по договорной цене (кто больше предложит), но **не менее** цены, указанной в карте.
...
**Исключение**: При неполной группе или заложенном предприятии плата **не взимается**.

### Клетки «Письмо», «Риск», «Сюрприз»

Игрок берет верхнюю карту из соответствующей колоды (лежащей вниз текстом), выполняет операции, предусмотренные картой, и кладет ее **вниз колоды**.
...
- Бросить три кубика и набрать **не менее 13 очков** при своем очередном ходе
...
- Рэкетир помечает свою фишку или банкир делает отметки
...
**Штраф 2,000 руб.** платится в банк, если игрок:
- Сходил чужой фишкой, ИЛИ
- Не полностью отдал сопернику деньги

### Наказание банкира

Банкир, уличенный в **нечестных операциях** с деньгами банка или личными средствами:
- Должен **прекратить игру**
- Его собственность становится **ничейной** и снова вступает в игру
- Для продолжения игры выбирается **новый руководитель банка**
...
1. **Передача карточек**: При покупке участка карточка «Предприятие» передается собственнику, равно как карточки «Участок земли» и «Госпредприятие»

2. **Добровольность рэкета**: При остановке на клетке «Рэкет» на игрока не обязательно распространяется правило «рэкетирства» — это зависит от его желания

3. **Карточка «Собственность»**: Удостоверяет право игрока на владение участком и дальнейшее строительство на нем филиала, отделения и головного предприятия
...
**От автора реконструкции**: Все творческие и технические усилия, поиски и время, затраченное на проект, посвящаю **Ерофееву Б.Т. (1928-2012)**, моему партнеру по этой игре 20 лет назад.
